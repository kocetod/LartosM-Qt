...
#include "../LartosM-Qt/Hik/ProcessingThread.h"
...
void ProcessingThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newFrame((*reinterpret_cast< const QPixmap(*)>(_a[1]))); break;
        ...
        {
            typedef void (ProcessingThread::*_t)(const QPixmap & );
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProcessingThread::newName)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ProcessingThread::newFrame(const QPixmap & _t1)
{
