...
CMercator::CMercator()
{
 ...
 /* Ellipsoid Parameters, default to WGS 84 */
	Merc_a = 6378137.0;    /* Semi-major axis of ellipsoid in meters */
	Merc_f = 1 / 298.257223563;      /* Flattening of ellipsoid */
	Merc_e = 0.08181919084262188000; /* Eccentricity of ellipsoid    */
	Merc_es = 0.0066943799901413800; /* Eccentricity squared         */

	/* Mercator projection Parameters */
	Merc_Origin_Lat = 0.0;      /* Latitude of origin in radians     */
	Merc_Origin_Long = 0.0;     /* Longitude of origin in radians    */
	Merc_False_Northing = 0.0;  /* False northing in meters          */
	Merc_False_Easting = 0.0;   /* False easting in meters           */
	Merc_Scale_Factor = 1.0;    /* Scale factor                      */
...
long CMercator::Set_Mercator_Parameters(double a,
                             double f,
 ...
 */
  ...
  { /* no errors */
    ...
    Merc_es = 2 * Merc_f - Merc_f * Merc_f;	// sqr(Ekscentricitet)
    Merc_e = sqrt(Merc_es);					//Ekscentricitet
...
void CMercator::Get_Mercator_Parameters(double *a,
                             double *f,
                             double *Origin_Latitude,
                             double *Central_Meridian,
                             double *False_Easting,
...
long CMercator::Convert_Geodetic_To_Mercator (double Latitude,
                                   double Longitude,
                                   double *Easting,
                                   double *Northing)
...
long CMercator::Convert_Mercator_To_Geodetic(double Easting,
                                  double Northing,
                                  double *Latitude,
                                  double *Longitude)
