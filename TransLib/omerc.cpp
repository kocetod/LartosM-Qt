 ...
 *                              FUNCTIONS     
 */
CObliqueMercator::CObliqueMercator()
{
/* Ellipsoid Parameters, default to WGS 84 */
	OMerc_a = 6378137.0;                   /* Semi-major axis of ellipsoid, in meters */
	OMerc_f = 1 / 298.257223563;           /* Flattening of ellipsoid */
	...
	OMerc_azimuth = .60940407333533;       /* Azimuth of central line as it crosses origin lat */
	OMerc_Origin_Long = -.46732023406900;  /* Longitude at center of projection */
	...
	OMerc_u = 5632885.2272051;             /* Coordinates for center point (uc , vc), vc = 0 */
													   /* at center lat and lon */
/* Oblique Mercator projection Parameters */
	OMerc_Origin_Lat = ((45.0 * PI) / 180.0);/* Latitude of projection center, in radians */
	OMerc_Lat_1 = ((40.0 * PI) / 180.0);     /* Latitude of first point lying on central line */
	OMerc_Lon_1 = ((-5.0 * PI) / 180.0);     /* Longitude of first point lying on central line */
	OMerc_Lat_2 = ((50.0 * PI) / 180.0);     /* Latitude of second point lying on central line */
	OMerc_Lon_2 = ((5.0 * PI) / 180.0);      /* Longitude of second point lying on central line */
	OMerc_Scale_Factor = 1.0;                /* Scale factor at projection center */
	OMerc_False_Northing = 0.0;              /* False northing, in meters, at projection center */
	OMerc_False_Easting = 0.0;               /* False easting, in meters, at projection center */
...
long CObliqueMercator::Set_Oblique_Mercator_Parameters(double a,
                                     double f,
...
void CObliqueMercator::Get_Oblique_Mercator_Parameters(double *a,
                                     double *f,
                                     double *Origin_Latitude,
                                     double *Latitude_1,
                                     double *Longitude_1,
...
long CObliqueMercator::Convert_Geodetic_To_Oblique_Mercator(double Latitude,
                                          double Longitude,
                                          double *Easting,
                                          double *Northing)
...
long CObliqueMercator::Convert_Oblique_Mercator_To_Geodetic(double Easting,
                                          double Northing,
                                          double *Latitude,
                                          double *Longitude)
