...
public:
	double UTM_a;        /* Semi-major axis of ellipsoid in meters  */
	double UTM_f;        /* Flattening of ellipsoid GRS80                 */
 ...
 */
	...
	void Return_UTM_Error_Text(long status, char *String);
	long UTMZoneFromBL(double B, double L, int* UTMZone);
};
