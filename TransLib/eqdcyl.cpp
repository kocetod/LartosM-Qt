 ...
 *                              FUNCTIONS
 */
CEquiDistCyl::CEquiDistCyl()
{
/* Ellipsoid Parameters, default to WGS 84 */
	Eqcy_a = 6378137.0;                  /* Semi-major axis of ellipsoid in meters */
	Eqcy_f = 1 / 298.257223563;          /* Flattening of ellipsoid */
	...
	Ra = 6371007.1810824;                /* Spherical Radius  */

/* Equidistant Cylindrical projection Parameters */
	Eqcy_Std_Parallel = 0.0;             /* Latitude of standard parallel in radians     */
	Cos_Eqcy_Std_Parallel = 1.0;         /* cos(Eqcy_Std_Parallel)  */
	Eqcy_Origin_Long = 0.0;              /* Longitude of origin in radians    */
	...
	Ra_Cos_Eqcy_Std_Parallel = 6371007.1810824; /* Ra * Cos_Eqcy_Std_Parallel */
}
...
long CEquiDistCyl::Set_Equidistant_Cyl_Parameters(double a,
                                    double f,
                                    double Std_Parallel,
...
void CEquiDistCyl::Get_Equidistant_Cyl_Parameters(double *a,
                                    double *f,
                                    double *Std_Parallel,
                                    double *Central_Meridian,
                                    double *False_Easting,
...
long CEquiDistCyl::Convert_Geodetic_To_Equidistant_Cyl (double Latitude,
                                          double Longitude,
                                          double *Easting,
                                          double *Northing)
...
long CEquiDistCyl::Convert_Equidistant_Cyl_To_Geodetic(double Easting,
                                         double Northing,
                                         double *Latitude,
                                         double *Longitude)
