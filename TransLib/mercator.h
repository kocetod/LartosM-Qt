...
class CMercator : CProjection
{
private:
	double MAX_LAT;  /* 89.5 degrees in radians         */
public:
	/* Ellipsoid Parameters, default to WGS 84 */
	double Merc_a;    /* Semi-major axis of ellipsoid in meters */
	double Merc_f;    /* Flattening of ellipsoid */
	double Merc_e;    /* Eccentricity of ellipsoid    */
	double Merc_es;   /* Eccentricity squared         */

	/* Mercator projection Parameters */
	double Merc_Origin_Lat;      /* Latitude of origin in radians     */
	double Merc_Origin_Long;     /* Longitude of origin in radians    */
