 ...
 *
 */
CStereographic::CStereographic()
{
/* Ellipsoid Parameters, default to WGS 84  */
	Stereo_a = 6378137.0;                    /* Semi-major axis of ellipsoid, in meters  */
	Stereo_f = 1 / 298.257223563;            /* Flattening of ellipsoid  */
	Stereo_Ra = 6371007.1810824;             /* Spherical Radius */
	Two_Stereo_Ra = 12742014.3621648;        /* 2 * Spherical Radius */
	Stereo_At_Pole = 0;                        /* Flag variable */

/* Stereographic projection Parameters */
	Stereo_Origin_Lat = 0.0;                 /* Latitude of origin, in radians */
	Stereo_Origin_Long = 0.0;                /* Longitude of origin, in radians */
	Stereo_False_Easting = 0.0;              /* False easting, in meters */
	Stereo_False_Northing = 0.0;             /* False northing, in meters */
	Sin_Stereo_Origin_Lat = 0.0;             /* sin(Stereo_Origin_Lat) */
	Cos_Stereo_Origin_Lat = 1.0;             /* cos(Stereo_Origin_Lat) */
...
long CStereographic::Set_Stereographic_Parameters (double a,
                                   double f,
...
void CStereographic::Get_Stereographic_Parameters(double *a,
                                  double *f,
                                  double *Origin_Latitude,
                                  double *Central_Meridian,
                                  double *False_Easting,
...
long CStereographic::Convert_Geodetic_To_Stereographic (double Latitude,
                                        double Longitude,
                                        double *Easting,
                                        double *Northing)
...
long CStereographic::Convert_Stereographic_To_Geodetic(double Easting,
                                       double Northing,
                                       double *Latitude,
                                       double *Longitude)
