 ...
 *                                for NZMG.C
 */
class CNZMG :CProjection
{
public:

	/* Ellipsoid Parameters, must be International  */
	double NZMG_a;         /* Semi-major axis of ellipsoid, in meters */
	char NZMG_Ellipsoid_Code[3];
	/* NZMG projection Parameters */
	double NZMG_Origin_Lat;               /* Latitude of origin, in radians */
	double NZMG_Origin_Long; /* Longitude of origin, in radians */
	double NZMG_False_Northing;         /* False northing, in meters */
	double NZMG_False_Easting;          /* False easting, in meters */
