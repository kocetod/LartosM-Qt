...
/* Ellipsoid Parameters, default to WGS 84 */
	Albers_a = 6378137.0;                   /* Semi-major axis of ellipsoid in meters */
	Albers_f = 1 / 298.257223563;           /* Flattening of ellipsoid */
	es = 0.08181919084262188000;            /* Eccentricity of ellipsoid */
	es2 = 0.0066943799901413800;            /* Eccentricity squared         */
	C =1.4896626908850;                     /* constant c   */
	rho0 = 6388749.3391064;                 /* height above ellipsoid		*/
	n = .70443998701755;                    /* ratio between meridians		*/
	Albers_a_OVER_n = 9054194.9882824;      /* Albers_a / n */
	one_MINUS_es2 = .99330562000986;        /* 1 - es2 */
	two_es = .16363838168524;               /* 2 * es */

/* Albers Projection Parameters */
	Albers_Origin_Lat = (45 * PI / 180);    /* Latitude of origin in radians     */
	Albers_Origin_Long = 0.0;               /* Longitude of origin in radians    */
...
long CAlbers::Set_Albers_Parameters(double a,
                           double f,
...
void CAlbers::Get_Albers_Parameters(double *a,
                           double *f,
                           double *Origin_Latitude,
                           double *Central_Meridian,
                           double *Std_Parallel_1,
...
long CAlbers::Convert_Geodetic_To_Albers (double Latitude,
                                 double Longitude,
                                 double *Easting,
                                 double *Northing)
...
long CAlbers::Convert_Albers_To_Geodetic(double Easting,
                                double Northing,
                                double *Latitude,
                                double *Longitude)
