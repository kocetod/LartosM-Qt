...
/* Ellipsoid Parameters, default to WGS 84 */
	Eck6_a = 6378137.0;                      /* Semi-major axis of ellipsoid in meters */
	Eck6_f = 1 / 298.257223563;              /* Flattening of ellipsoid */
	...
	Ra_Over_Sqrt_Two_Plus_PI = 2809695.5356062;      /* Ra(6371007.1810824)/Sqrt(2.0 + PI) */
	Inv_Ra_Over_Sqrt_Two_Plus_PI = 3.5591044913137e-007; /* Sqrt(2.0 + PI)/Ra(6371007.1810824) */


/* Eckert6 projection Parameters */
	Eck6_Origin_Long = 0.0;                         /* Longitude of origin in radians    */
...
long CEckert6::Set_Eckert6_Parameters(double a,
                            double f,
...
void CEckert6::Get_Eckert6_Parameters(double *a,
                            double *f,
                            double *Central_Meridian,
                            double *False_Easting,
                            double *False_Northing)
...
long CEckert6::Convert_Geodetic_To_Eckert6 (double Latitude,
                                  double Longitude,
                                  double *Easting,
                                  double *Northing)
...
long CEckert6::Convert_Eckert6_To_Geodetic(double Easting,
                                 double Northing,
                                 double *Latitude,
                                 double *Longitude)
