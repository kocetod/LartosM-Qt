...
class CUPS :CProjection
{
private:
	double MAX_LAT;    /* 90 degrees in radians */
	double MAX_ORIGIN_LAT;
	double MIN_NORTH_LAT;
	double MIN_SOUTH_LAT;
	double MIN_EAST_NORTH;
	double MAX_EAST_NORTH;
public:
	/* Ellipsoid Parameters, default to WGS 84  */
	double UPS_a;          /* Semi-major axis of ellipsoid in meters   */
	double UPS_f;  /* Flattening of ellipsoid  */
