...
/* Ellipsoid Parameters, default to WGS 84 */
	Gnom_a = 6378137.0;                  /* Semi-major axis of ellipsoid in meters */
	Gnom_f = 1 / 298.257223563;          /* Flattening of ellipsoid */
	Ra = 6371007.1810824;                /* Spherical Radius */
	Sin_Gnom_Origin_Lat = 0.0;
	Cos_Gnom_Origin_Lat = 1.0;

/* Gnomonic projection Parameters */
	Gnom_Origin_Lat = 0.0;               /* Latitude of origin in radians */
	Gnom_Origin_Long = 0.0;              /* Longitude of origin in radians */
	Gnom_False_Northing = 0.0;           /* False northing in meters */
	Gnom_False_Easting = 0.0;            /* False easting in meters */
...
long CGnomonic::Set_Gnomonic_Parameters(double a,
                             double f,
...
void CGnomonic::Get_Gnomonic_Parameters(double *a,
                             double *f,
                             double *Origin_Latitude,
                             double *Central_Meridian,
                             double *False_Easting,
...
long CGnomonic::Convert_Geodetic_To_Gnomonic (double Latitude,
                                   double Longitude,
                                   double *Easting,
                                   double *Northing)
...
long CGnomonic::Convert_Gnomonic_To_Geodetic(double Easting,
                                  double Northing,
                                  double *Latitude,
                                  double *Longitude)
