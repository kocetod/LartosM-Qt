 ...
 *                              FUNCTIONS
 */
CMollweide::CMollweide()
{
/* Ellipsoid Parameters, default to WGS 84 */
	Moll_a = 6378137.0;                /* Semi-major axis of ellipsoid in meters */
	Moll_f = 1 / 298.257223563;        /* Flattening of ellipsoid */
	...
	Sqrt2_Ra = 9009964.7614632;        /* sqrt(2.0) * Spherical Radius(6371007.1810824) */
	Sqrt8_Ra = 18019929.522926;        /* sqrt(8.0) * Spherical Radius(6371007.1810824) */

/* Mollweide projection Parameters */
	Moll_Origin_Long = 0.0;            /* Longitude of origin in radians    */
...
long CMollweide::Set_Mollweide_Parameters(double a,
                              double f,
...
void CMollweide::Get_Mollweide_Parameters(double *a,
                              double *f,
                              double *Central_Meridian,
                              double *False_Easting,
                              double *False_Northing)
...
long CMollweide::Convert_Geodetic_To_Mollweide (double Latitude,
                                    double Longitude,
                                    double *Easting,
                                    double *Northing)
...
long CMollweide::Convert_Mollweide_To_Geodetic(double Easting,
                                   double Northing,
                                   double *Latitude,
                                   double *Longitude)
