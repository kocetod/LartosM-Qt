...
CUPS::CUPS()
{
	MAX_LAT = ((PI * 90) / 180.0);    /* 90 degrees in radians */
	MAX_ORIGIN_LAT = ((81.114528 * PI) / 180.0);
	MIN_NORTH_LAT = (83.5*PI / 180.0);
	MIN_SOUTH_LAT = (-79.5*PI / 180.0);
	MIN_EAST_NORTH = 0;
	MAX_EAST_NORTH = 4000000;

	/* Ellipsoid Parameters, default to WGS 84  */
	UPS_a = 6378137.0;          /* Semi-major axis of ellipsoid in meters   */
	UPS_f = 1 / 298.257223563;  /* Flattening of ellipsoid  */
	UPS_False_Easting = 2000000;
	UPS_False_Northing = 2000000;
	UPS_Origin_Latitude = MAX_ORIGIN_LAT;  /*set default = North Hemisphere */
...
long CUPS::Set_UPS_Parameters( double a,
                         double f)
{
/*
...
void CUPS::Get_UPS_Parameters( double *a,
                         double *f)
{
/*
...
long CUPS::Convert_Geodetic_To_UPS ( double Latitude,
                               double Longitude,
                               char   *Hemisphere,
                               double *Easting,
                               double *Northing)
 ...
 */
  ...
  {  /* no errors */
	...
	CPolarst objPolarst;
	objPolarst.Set_Polar_Stereographic_Parameters( UPS_a,
                                        UPS_f,
                                        UPS_Origin_Latitude,
	...
	objPolarst.Convert_Geodetic_To_Polar_Stereographic(Latitude,
                                            Longitude,
                                            &tempEasting,
                                            &tempNorthing);
...
long CUPS::Convert_UPS_To_Geodetic(char   Hemisphere,
                             double Easting,
                             double Northing,
                             double *Latitude,
                             double *Longitude)
 ...
 */
  ...
  {   /*  no errors   */
	...
	objPolarst.Convert_Polar_Stereographic_To_Geodetic( Easting,
                                             Northing,
                                             Latitude,
                                             Longitude); 
