 ...
 *                              FUNCTIONS     
 */
CSinusoidal::CSinusoidal()
{
/* Ellipsoid Parameters, default to WGS 84 */
	Sinu_a = 6378137.0;                      /* Semi-major axis of ellipsoid in meters */
	Sinu_f = 1 / 298.257223563;              /* Flattening of ellipsoid */
...
/* Sinusoid projection Parameters */
	Sinu_Origin_Long = 0.0;                  /* Longitude of origin in radians    */
	Sinu_False_Northing = 0.0;               /* False northing in meters          */
	Sinu_False_Easting = 0.0;                /* False easting in meters           */
...
long CSinusoidal::Set_Sinusoidal_Parameters(double a,
                               double f,
...
void CSinusoidal::Get_Sinusoidal_Parameters(double *a,
                               double *f,
                               double *Central_Meridian,
                               double *False_Easting,
                               double *False_Northing)
...
long CSinusoidal::Convert_Geodetic_To_Sinusoidal (double Latitude,
                                     double Longitude,
                                     double *Easting,
                                     double *Northing)
...
long CSinusoidal::Convert_Sinusoidal_To_Geodetic(double Easting,
                                    double Northing,
                                    double *Latitude,
                                    double *Longitude)
