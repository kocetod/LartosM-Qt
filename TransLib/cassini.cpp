...
/* Ellipsoid Parameters, default to WGS 84 */
	Cass_a = 6378137.0;                      /* Semi-major axis of ellipsoid in meters */
	Cass_f = 1 / 298.257223563;              /* Flattening of ellipsoid */
...
/* Cassini projection Parameters */
	Cass_Origin_Lat = 0.0;                   /* Latitude of origin in radians     */
	Cass_Origin_Long = 0.0;                  /* Longitude of origin in radians    */
	Cass_False_Northing = 0.0;               /* False northing in meters          */
	Cass_False_Easting = 0.0;                /* False easting in meters           */
...
long CCassini::Set_Cassini_Parameters(double a,
                            double f,
...
void CCassini::Get_Cassini_Parameters(double *a,
                            double *f,
                            double *Origin_Latitude,
                            double *Central_Meridian,
                            double *False_Easting,
...
long CCassini::Convert_Geodetic_To_Cassini (double Latitude,
                                  double Longitude,
                                  double *Easting,
                                  double *Northing)
...
long CCassini::Convert_Cassini_To_Geodetic(double Easting,
                                 double Northing,
                                 double *Latitude,
                                 double *Longitude)
