...
class CLocCartesian : CProjection
{
public:
	/* Ellipsoid Parameters, default to WGS 84 */
	double LocalCart_a;         /* Semi-major axis of ellipsoid in meters */
	double LocalCart_f; /* Flattening of ellipsoid */
	double es2;     /* Eccentricity (0.08181919084262188000) squared         */
	double U0;                  /* Geocentric origin U coordinate */
	double V0;                        /* Geocentric origin V coordinate */
	double W0;                        /* Geocentric origin W coordinate */
