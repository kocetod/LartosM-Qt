...
/* Ellipsoid Parameters, default to WGS 84 */
	Orth_a = 6378137.0;                      /* Semi-major axis of ellipsoid in meters */
	Orth_f = 1 / 298.257223563;              /* Flattening of ellipsoid */
...
/* Orthographic projection Parameters */
	Orth_Origin_Lat = 0.0;                   /* Latitude of origin in radians     */
	Orth_Origin_Long = 0.0;                  /* Longitude of origin in radians    */
	Orth_False_Easting = 0.0;
	Orth_False_Northing = 0.0;
	Sin_Orth_Origin_Lat = 0.0;               /* sin(Orth_Origin_Lat) */
	Cos_Orth_Origin_Lat = 1.0;               /* cos(Orth_Origin_Lat) */
/*
...
long COrthographic::Set_Orthographic_Parameters(double a,
                                 double f,
...
void COrthographic::Get_Orthographic_Parameters(double *a,
                                 double *f,
                                 double *Origin_Latitude,
                                 double *Central_Meridian,
                                 double *False_Easting,
...
long COrthographic::Convert_Geodetic_To_Orthographic (double Latitude,
                                       double Longitude,
                                       double *Easting,
                                       double *Northing)
...
long COrthographic::Convert_Orthographic_To_Geodetic(double Easting,
                                      double Northing,
                                      double *Latitude,
                                      double *Longitude)
