...
/* Ellipsoid Parameters, must be International  */
	NZMG_a = 6378388.0;         /* Semi-major axis of ellipsoid, in meters */
	strcpy(NZMG_Ellipsoid_Code, "IN");
/* NZMG projection Parameters */
	NZMG_Origin_Lat = (-41.0);               /* Latitude of origin, in radians */
	NZMG_Origin_Long = (173.0 * PI / 180.0); /* Longitude of origin, in radians */
	NZMG_False_Northing = 6023150.0;         /* False northing, in meters */
	NZMG_False_Easting = 2510000.0;          /* False easting, in meters */
...
Complex CNZMG::Add(Complex z1, Complex z2)
{
  Complex z;
...
Complex CNZMG::Multiply(Complex z1, Complex z2)
{
  Complex z;
...
Complex CNZMG::Divide(Complex z1, Complex z2)
{
  Complex z;
  double denom;
...
long CNZMG::Set_NZMG_Parameters(char *Ellipsoid_Code)
...
void CNZMG::Get_NZMG_Parameters(char *Ellipsoid_Code)
...
long CNZMG::Convert_Geodetic_To_NZMG (double Latitude,
                               double Longitude,
                               double *Easting,
                               double *Northing)
...
long CNZMG::Convert_NZMG_To_Geodetic(double Easting,
                              double Northing,
                              double *Latitude,
                              double *Longitude)
