...
CNeys::CNeys()
{
	...
	Neys_a = 6378137.0;               /* Semi-major axis of ellipsoid, in meters */
	Neys_f = 1 / 298.257223563;       /* Flattening of ellipsoid */

	/* Ney's projection Parameters */
	Neys_Std_Parallel_1 = SEVENTY_ONE;     /* Lower std. parallel, in radians */
	Neys_Std_Parallel_2 = MAX_LAT;         /* Upper std. parallel, in radians */
	Neys_Origin_Lat = (80.0 * PI / 180.0); /* Latitude of origin, in radians */
	Neys_Origin_Long = 0.0;                /* Longitude of origin, in radians */
	Neys_False_Northing = 0.0;             /* False northing, in meters */
	Neys_False_Easting = 0.0;              /* False easting, in meters */

	/* Maximum variance for easting and northing values for WGS 84. */
	Neys_Delta_Easting = 40000000.0;
	Neys_Delta_Northing = 40000000.0;
...
long CNeys::Set_Neys_Parameters(double a,
                         double f,
 ...
 */
  ...
  { /* no errors */
	...
	objLambert.Set_Lambert_Parameters(Neys_a, Neys_f, Neys_Origin_Lat, Neys_Origin_Long,
...
void CNeys::Get_Neys_Parameters(double *a,
                         double *f,
                         double *Origin_Latitude,
                         double *Central_Meridian,
                         double *Std_Parallel_1,
...
long CNeys::Convert_Geodetic_To_Neys(double Latitude,
                              double Longitude,
                              double *Easting,
                              double *Northing)
 ...
 */
  ...
  { /* no errors */
    ...
    temp_Error = objLambert.Convert_Geodetic_To_Lambert(Latitude, Longitude, Easting, Northing);
...
long CNeys::Convert_Neys_To_Geodetic(double Easting,
                              double Northing,
                              double *Latitude,
                              double *Longitude)
 ...
 */
  ...
  { /* no errors */
    ...
    temp_Error = objLambert.Convert_Lambert_To_Geodetic(Easting, Northing, Latitude, Longitude);
