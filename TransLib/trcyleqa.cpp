 ...
 *                              FUNCTIONS
 */
CTransCylEqArea::CTransCylEqArea()
{
/* Ellipsoid Parameters, default to WGS 84 */
	Tcea_a = 6378137.0;                /* Semi-major axis of ellipsoid in meters */
	Tcea_f = 1 / 298.257223563;        /* Flattening of ellipsoid */
	...
	es = .081819190842622;             /* sqrt(es2) */
	M0 = 0.0; 
	qp = 1.9955310875028;
	One_MINUS_es2 = .99330562000986;   /* 1.0 - es2 */
	One_OVER_2es = 6.1110357466348;    /* 1.0 / (2.0 * es) */
	a0 = .0022392088624809;     /* es2 / 3.0 + 31.0 * es4 / 180.0 + 517.0 * es6 / 5040.0 */
	a1 = 2.8830839728915e-006;         /*  23.0 * es4 / 360.0 + 251.0 * es6 / 3780.0 */
	a2 = 5.0331826636906e-009;         /* 761.0 * es6 / 45360.0 */
	b0 = .0025188265843907;            /* 3.0 * e1 / 2.0 - 27.0 * e3 / 32.0 */
	b1 = 3.7009490356205e-006;         /* 21.0 * e2 / 16.0 - 55.0 * e4 / 32.0 */
	b2 = 7.4478137675038e-009;         /* 151.0 * e3 / 96.0 */
	b3 = 1.7035993238596e-011;         /* 1097.0 * e4 / 512.0 */
	c0 = .99832429845280;              /* 1.0 - es2 / 4.0 - 3.0 * es4 / 64.0 - 5.0 * es6 / 256.0 */
...
/* Transverse Cylindrical Equal Area projection Parameters */
	Tcea_Origin_Lat = 0.0;             /* Latitude of origin in radians     */
	Tcea_Origin_Long = 0.0;            /* Longitude of origin in radians    */
	Tcea_False_Northing = 0.0;         /* False northing in meters          */
	Tcea_False_Easting = 0.0;          /* False easting in meters           */
	Tcea_Scale_Factor = 1.0;           /* Scale factor                      */
...
long CTransCylEqArea::Set_Trans_Cyl_Eq_Area_Parameters(double a,
                                      double f,
...
void CTransCylEqArea::Get_Trans_Cyl_Eq_Area_Parameters(double *a,
                                      double *f,
                                      double *Origin_Latitude,
                                      double *Central_Meridian,
                                      double *False_Easting,
...
long CTransCylEqArea::Convert_Geodetic_To_Trans_Cyl_Eq_Area (double Latitude,
                                            double Longitude,
                                            double *Easting,
                                            double *Northing)
...
long CTransCylEqArea::Convert_Trans_Cyl_Eq_Area_To_Geodetic(double Easting,
                                           double Northing,
                                           double *Latitude,
                                           double *Longitude)
