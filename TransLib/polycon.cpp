 ...
 *                              FUNCTIONS     
 */
CPolyconic::CPolyconic()
{
/* Ellipsoid Parameters, default to WGS 84 */
	Poly_a = 6378137.0;                      /* Semi-major axis of ellipsoid in meters */
	Poly_f = 1 / 298.257223563;              /* Flattening of ellipsoid */
...
/* Polyconic projection Parameters */
	Poly_Origin_Lat = 0.0;                   /* Latitude of origin in radians     */
	Poly_Origin_Long = 0.0;                  /* Longitude of origin in radians    */
	Poly_False_Northing = 0.0;               /* False northing in meters          */
	Poly_False_Easting = 0.0;                /* False easting in meters           */
...
long CPolyconic::Set_Polyconic_Parameters(double a,
                              double f,
...
void CPolyconic::Get_Polyconic_Parameters(double *a,
                              double *f,
                              double *Origin_Latitude,
                              double *Central_Meridian,
                              double *False_Easting,
...
long CPolyconic::Convert_Geodetic_To_Polyconic (double Latitude,
                                    double Longitude,
                                    double *Easting,
                                    double *Northing)
...
long CPolyconic::Convert_Polyconic_To_Geodetic(double Easting,
                                   double Northing,
                                   double *Latitude,
                                   double *Longitude)
