...
CEckert4::CEckert4()
{
	...
	Eck4_a = 6378137.0;                      /* Semi-major axis of ellipsoid in meters */
	Eck4_f = 1 / 298.257223563;              /* Flattening of ellipsoid */
	...
	Ra0 = 2690082.6043273;                   /* 0.4222382 * Sperical Radius (6371007.1810824) */
	Ra1 = 8451143.5741087;                   /* 1.3265004 * Sperical Radius (6371007.1810824) */

	/* Eckert4 projection Parameters */
	Eck4_Origin_Long = 0.0;                  /* Longitude of origin in radians    */
...
long CEckert4::Set_Eckert4_Parameters(double a,
                            double f,                
...
void CEckert4::Get_Eckert4_Parameters(double *a,
                            double *f,                           
                            double *Central_Meridian,
                            double *False_Easting,
                            double *False_Northing)
...
long CEckert4::Convert_Geodetic_To_Eckert4 (double Latitude,
                                  double Longitude,
                                  double *Easting,
                                  double *Northing)
...
long CEckert4::Convert_Eckert4_To_Geodetic(double Easting,
                                 double Northing,
                                 double *Latitude,
                                 double *Longitude)
