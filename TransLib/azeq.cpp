 ...
 *                              FUNCTIONS     
 */
CAzimutalEq::CAzimutalEq()
{
/* Ellipsoid Parameters, default to WGS 84 */
	Azeq_a = 6378137.0;                  /* Semi-major axis of ellipsoid in meters */
	Azeq_f = 1 / 298.257223563;          /* Flattening of ellipsoid */
...
/* Azimuthal Equidistant projection Parameters */
	Azeq_Origin_Lat = 0.0;               /* Latitude of origin in radians */
	Azeq_Origin_Long = 0.0;              /* Longitude of origin in radians */
	Azeq_False_Northing = 0.0;           /* False northing in meters */
	Azeq_False_Easting = 0.0;            /* False easting in meters */
...
long CAzimutalEq::Set_Azimuthal_Equidistant_Parameters(double a,
                                          double f,
...
void CAzimutalEq::Get_Azimuthal_Equidistant_Parameters(double *a,
                                          double *f,
                                          double *Origin_Latitude,
                                          double *Central_Meridian,
                                          double *False_Easting,
...
long CAzimutalEq::Convert_Geodetic_To_Azimuthal_Equidistant (double Latitude,
                                                double Longitude,
                                                double *Easting,
                                                double *Northing)
...
long CAzimutalEq::Convert_Azimuthal_Equidistant_To_Geodetic(double Easting,
                                               double Northing,
                                               double *Latitude,
                                               double *Longitude)
