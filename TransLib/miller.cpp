...
/* Ellipsoid Parameters, default to WGS 84 */
	Mill_a = 6378137.0;                      /* Semi-major axis of ellipsoid in meters */
	Mill_f = 1 / 298.257223563;              /* Flattening of ellipsoid */
...
/* Miller projection Parameters */
	Mill_Origin_Long = 0.0;                  /* Longitude of origin in radians    */
...
long CMiller::Set_Miller_Parameters(double a,
                           double f,
...
void CMiller::Get_Miller_Parameters(double *a,
                           double *f,
                           double *Central_Meridian,
                           double *False_Easting,
                           double *False_Northing)
...
long CMiller::Convert_Geodetic_To_Miller (double Latitude,
                                 double Longitude,
                                 double *Easting,
                                 double *Northing)
...
long CMiller::Convert_Miller_To_Geodetic(double Easting,
                                double Northing,
                                double *Latitude,
                                double *Longitude)
