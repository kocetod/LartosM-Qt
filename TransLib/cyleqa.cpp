 ...
 *                              FUNCTIONS     
 */
CCylEqArea::CCylEqArea()
{
/* Ellipsoid Parameters, default to WGS 84 */
	Cyeq_a = 6378137.0;                     /* Semi-major axis of ellipsoid in meters */
	Cyeq_f = 1 / 298.257223563;             /* Flattening of ellipsoid */
	...
	k0 = 1.0;
	Cyeq_a_k0 = 6378137.0;                  /* Cyeq_a * k0 */
	two_k0 = 2.0;                           /* 2.0 * k0 */
	c0 = .0022392088624809;                 /* es2 / 3.0 + 31.0 * es4 / 180.0 + 517.0 * es6 / 5040.0 */
	c1 = 2.8830839728915e-006;              /* 23.0 es4 / 360.0 + 251.0 * es6 / 3780.0 */
	c2 = 5.0331826636906e-009;              /* 761.0 * es6 / 45360.0 */

/* Cylindrical Equal Area projection Parameters */
	Cyeq_Origin_Lat = 0.0;                  /* Latitude of origin in radians     */
	Cyeq_Origin_Long = 0.0;                 /* Longitude of origin in radians    */
	Cyeq_False_Northing = 0.0;              /* False northing in meters          */
	Cyeq_False_Easting = 0.0;               /* False easting in meters           */
...
long CCylEqArea::Set_Cyl_Eq_Area_Parameters(double a,
                                double f,
...
void CCylEqArea::Get_Cyl_Eq_Area_Parameters(double *a,
                                double *f,
                                double *Origin_Latitude,
                                double *Central_Meridian,
                                double *False_Easting,
...
long CCylEqArea::Convert_Geodetic_To_Cyl_Eq_Area (double Latitude,
                                      double Longitude,
                                      double *Easting,
                                      double *Northing)
...
long CCylEqArea::Convert_Cyl_Eq_Area_To_Geodetic(double Easting,
                                     double Northing,
                                     double *Latitude,
                                     double *Longitude)
