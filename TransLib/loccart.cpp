 ...
 *                              FUNCTIONS
 */
CLocCartesian::CLocCartesian()
{
/* Ellipsoid Parameters, default to WGS 84 */
	LocalCart_a = 6378137.0;         /* Semi-major axis of ellipsoid in meters */
	LocalCart_f = 1 / 298.257223563; /* Flattening of ellipsoid */
	es2 = 0.0066943799901413800;     /* Eccentricity (0.08181919084262188000) squared         */
	U0 = 6378137.0;                  /* Geocentric origin U coordinate */
	V0 = 0.0;                        /* Geocentric origin V coordinate */
	W0 = 0.0;                        /* Geocentric origin W coordinate */
	u0 = 6378137.0;                  /* Geocentric origin coordinates in */
	v0 = 0.0;                        /* terms of Local Cartesian origin  */
	w0 = 0.0;                        /* parameters                       */


/* Local Cartesian Projection Parameters */
	LocalCart_Origin_Lat = 0.0;      /* Latitude of origin in radians     */
	LocalCart_Origin_Long = 0.0;     /* Longitude of origin in radians    */
	LocalCart_Origin_Height = 0.0;   /* Height of origin in meters        */
	LocalCart_Orientation = 0.0;     /* Orientation of Y axis in radians  */

	Sin_LocalCart_Origin_Lat = 0.0;  /* sin(LocalCart_Origin_Lat)         */
	Cos_LocalCart_Origin_Lat = 1.0;  /* cos(LocalCart_Origin_Lat)         */
	Sin_LocalCart_Orientation = 0.0; /* sin(LocalCart_Orientation)        */
	Cos_LocalCart_Orientation = 1.0; /* cos(LocalCart_Orientation)        */

	Sin_Lat_Sin_Orient = 0.0; /* sin(LocalCart_Origin_Lat) * sin(LocalCart_Orientation) */
	Sin_Lat_Cos_Orient = 0.0; /* sin(LocalCart_Origin_Lat) * cos(LocalCart_Orientation) */
	Cos_Lat_Cos_Orient = 1.0; /* cos(LocalCart_Origin_Lat) * cos(LocalCart_Orientation) */
	Cos_Lat_Sin_Orient = 0.0; /* cos(LocalCart_Origin_Lat) * sin(LocalCart_Orientation) */
/*
...
long CLocCartesian::Set_Local_Cartesian_Parameters (double a,
                                     double f,
...
void CLocCartesian::Get_Local_Cartesian_Parameters (double *a,
                                     double *f,
                                     double *Origin_Latitude,
                                     double *Origin_Longitude,
                                     double *Origin_Height,
...
void CLocCartesian::Convert_Geocentric_To_Local_Cartesian (double u,
                                            double v,
                                            double w,
                                            double *X, 
                                            double *Y,
...
long CLocCartesian::Convert_Geodetic_To_Local_Cartesian (double Latitude,
                                          double Longitude,
                                          double Height,
                                          double *X,
                                          double *Y,
 ...
 */
  ...
  if (!Error_Code)
  {
	...
	CGeocent objGeocent;
	objGeocent.Convert_Geodetic_To_Geocentric(Latitude, dlong, Height, &U, &V, &W);
...
void CLocCartesian::Convert_Local_Cartesian_To_Geocentric (double X,
                                            double Y,
                                            double Z,
                                            double *u,
                                            double *v,
...
void CLocCartesian::Convert_Local_Cartesian_To_Geodetic (double X,
                                          double Y, 
                                          double Z,
                                          double *Latitude,
                                          double *Longitude,
 ...
 */
  ...
  CGeocent objGeocent;
  objGeocent.Convert_Geocentric_To_Geodetic(U, V, W, &templat, &templon, &tempheight);
