...
/* Ellipsoid Parameters, default to WGS 84 */
	Grin_a = 6378137.0;                      /* Semi-major axis of ellipsoid in meters */
	Grin_f = 1 / 298.257223563;              /* Flattening of ellipsoid */
...
/* Van Der Grinten projection Parameters */
	Grin_Origin_Long = 0.0;                  /* Longitude of origin in radians    */
...
long CGrinten::Set_Van_der_Grinten_Parameters(double a,
                                    double f,
...
void CGrinten::Get_Van_der_Grinten_Parameters(double *a,
                                    double *f,
                                    double *Central_Meridian,
                                    double *False_Easting,
                                    double *False_Northing)
...
long CGrinten::Convert_Geodetic_To_Van_der_Grinten (double Latitude,
                                          double Longitude,
                                          double *Easting,
                                          double *Northing)
...
long CGrinten::Convert_Van_der_Grinten_To_Geodetic(double Easting,
                                         double Northing,
                                         double *Latitude,
                                         double *Longitude)
