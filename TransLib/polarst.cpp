...
CPolarst::CPolarst()
{
	...
	Polar_a = 6378137.0;                    /* Semi-major axis of ellipsoid in meters  */
	Polar_f = 1 / 298.257223563;            /* Flattening of ellipsoid  */
	es = 0.08181919084262188000;            /* Eccentricity of ellipsoid    */
	es_OVER_2 = .040909595421311;           /* es / 2.0 */
	Southern_Hemisphere = 0;                /* Flag variable */
	mc = 1.0;
	tc = 1.0;
	e4 = 1.0033565552493;
	Polar_a_mc = 6378137.0;                 /* Polar_a * mc */
	two_Polar_a = 12756274.0;               /* 2.0 * Polar_a */

	/* Polar Stereographic projection Parameters */
	Polar_Origin_Lat = ((PI * 90) / 180);   /* Latitude of origin in radians */
	Polar_Origin_Long = 0.0;                /* Longitude of origin in radians */
	Polar_False_Easting = 0.0;              /* False easting in meters */
	Polar_False_Northing = 0.0;             /* False northing in meters */
...
long CPolarst::Set_Polar_Stereographic_Parameters (double a,
                    double f,
...
void CPolarst::Get_Polar_Stereographic_Parameters (double *a,
                    double *f,
                    double *Latitude_of_True_Scale,
                    double *Longitude_Down_from_Pole,
                    double *False_Easting,
...
long CPolarst::Convert_Geodetic_To_Polar_Stereographic (double Latitude,
                    double Longitude,
                    double *Easting,
                    double *Northing)
...
long CPolarst::Convert_Polar_Stereographic_To_Geodetic (double Easting,
                    double Northing,
                    double *Latitude,
                    double *Longitude)
